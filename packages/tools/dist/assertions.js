...
export class AssertionEngine {
    ...
    async assertText(text, expectation, model = "claude-sonnet-4-20250514") {
    ...
    async assertScreenshot(screenshotBase64, expectation, model = "claude-sonnet-4-20250514") {
        const response = await this.client.messages.create({
            model,
            max_tokens: 512,
            messages: [{
     ...
     */
    async compareScreenshots(currentBase64, baselineBase64, context, model = "claude-sonnet-4-20250514") {
...
pass=true means no meaningful regression. pass=false means a real visual regression was detected.`
     ...
     */
    async detectVisualIssues(screenshotBase64, context, model = "claude-sonnet-4-20250514") {
...
function parseAssertionResponse(response) {
    const textBlock = response.content.find(b => b.type === "text");
    if (!textBlock) {
