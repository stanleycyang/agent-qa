...
export class ExplainAgent extends LogicAgent {
    rootDir;
    constructor(model, rootDir = process.cwd()) {
        super(model);
    ...
    async handleToolCall(name, input) {
        switch (name) {
            ...
            case "read_network_log": {
                const replayDir = input.replay_dir;
...
Produce a forensic report explaining what went wrong and how to fix it.`;
        return this.runConversation(this.buildSystemPrompt({}), prompt, { maxToolResultBytes: 8000 });
    }
}
//# sourceMappingURL=explain-agent.js.map